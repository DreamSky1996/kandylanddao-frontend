...
```bash
$ git clone https://github.com/Kandylnad/kandylnad.git
$ cd kandylnad
...
| Branch | URL |
| --- | --- |
| master | https://app.kandylnad.finance |
| deploy | https://staging.kandylnad.finance |
...
We keep an updated list of bugs/feature requests in [Github Issues](https://github.com/Kandylnad/kandylnad/issues). 


![GitHub issues](https://img.shields.io/github/issues/kandylnad/kandylnad?style=flat-square)

Filter by ["good first issue"](https://github.com/Kandylnad/kandylnad/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22) to get your feet wet!
